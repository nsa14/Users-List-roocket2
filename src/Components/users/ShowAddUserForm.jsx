...
const ShowAddUserForm = ({setStateOfParent}) => {
    ...
    return (
        <>
            ...
            <Modal onSubmit={handleSubmit(onSubmit)} show={isOpen} fullscreen onHide={changeModalStatus}
                   className="modal fade-scalenewUserComponent.jsx" aria-labelledby="example-modal-sizes-title-lg">
                ...
                <Modal.Body>
                    <Form className="col-md-4 mx-auto" style={{textAlign: 'right'}}>
                        <Form.Group className="mb-3" controlId="exampleForm.name">
                            ...
                            <input {...register("name", {required: true})} placeholder="نام را وارد کنید" className={'form-control'}
                                   value={stateForm.name} onChange={formEventHandler}/>
                        ...
                        >
                            ...
                            <input {...register("family", {required: true})} placeholder="نام خانوادگی را وارد کنید" className={'form-control'}
                                   value={stateForm.family} onChange={formEventHandler}/>
                        ...
                        >
                            ...
                            <input {...register("email", {required: true, pattern: /^\S+@\S+$/i})} placeholder="ایمیل را وارد کنید"
                                   className={'form-control'} value={stateForm.email} onChange={formEventHandler}/>
                        ...
                        >
                            ...
                            <input {...register("password", {required: true})} placeholder="رمز عبور را وارد کنید" className={'form-control'}
                                   value={stateForm.password} onChange={formEventHandler}/>
